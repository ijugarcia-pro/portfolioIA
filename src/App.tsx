      ...
      >
        <div className="container mx-auto px-6 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            {['Expertise', 'Expérience', 'Projets', 'Contact'].map(
              (item, idx) => {
                ...
                return (
                  <button
                    ...
                    className="text-sm font-medium hover:text-teal-400 transition-colors relative group"
                  >
                    {item}
      ...
      >
        ...
        <div className="container mx-auto max-w-5xl text-center">
          ...
          <p className="text-slate-400 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
            Je transforme vos données brutes en stratégies marketing
            performantes. Double compétence technique et business pour accélérer
            votre croissance.
          </p>
          <div className="flex flex-col md:flex-row justify-center items-center gap-4">
            <button
              onClick={() => scrollTo('contact')}
              className="w-full md:w-auto px-8 py-4 bg-teal-500 hover:bg-teal-600 text-slate-900 rounded-full font-bold transition-all shadow-lg shadow-teal-500/20 flex items-center justify-center gap-2"
            >
              Discuter de votre projet <ChevronRight size={18} />
            </button>
            <button
              onClick={() => scrollTo('experience')}
              className="w-full md:w-auto px-8 py-4 bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 rounded-full font-bold transition-all flex items-center justify-center gap-2"
            >
              Voir mon parcours
            </button>
          </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-slate-900 border border-slate-800 hover:border-teal-500/50 transition-all hover:transform hover:-translate-y-1 group">
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <span
                    key={tag}
                    className="px-3 py-1 bg-slate-800 rounded-full text-xs font-medium text-slate-300 border border-slate-700"
                  >
                    {tag}
                  </span>
                ))}
            ...
            <div className="p-8 rounded-2xl bg-slate-900 border border-slate-800 hover:border-teal-500/50 transition-all hover:transform hover:-translate-y-1 group">
              ...
              <div className="flex flex-wrap gap-2">
                {['React', 'HTML/CSS', 'WordPress', 'Figma', 'UI/UX'].map(
                  (tag) => (
                    <span
                      key={tag}
                      className="px-3 py-1 bg-slate-800 rounded-full text-xs font-medium text-slate-300 border border-slate-700"
          ...
          <div className="space-y-8 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-700 before:to-transparent">
            <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
              ...
              <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-slate-950 p-6 rounded-xl border border-slate-800 hover:border-teal-500/30 transition-all shadow-lg">
                ...
                <ul className="text-sm text-slate-400 list-disc list-inside space-y-1">
                  ...
                  <li>
                    Développement d'un prompt IA (-2h de travail/semaine).
                  </li>
            ...
            <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
              ...
              <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-slate-950 p-6 rounded-xl border border-slate-800 hover:border-indigo-500/30 transition-all shadow-lg">
                ...
                <div className="text-sm font-semibold text-slate-400 mb-3">
                  Chef de projet Marketing Inbound
                </div>
                <ul className="text-sm text-slate-400 list-disc list-inside space-y-1">
                  <li>
                    Pilotage de la stratégie Marketing Automation (HubSpot).
                  </li>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400">
              Exemples de missions réalisables pour mes clients
            </p>
          </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-slate-900 border border-slate-800 transition-all hover:border-teal-500">
              <div className="h-48 bg-slate-800 relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-teal-900/50 to-slate-900 flex items-center justify-center">
                  <LineChart
                    size={48}
                    className="text-teal-500/50 group-hover:scale-110 transition-transform duration-500"
                  />
                </div>
              </div>
              <div className="p-6">
                ...
                <p className="text-sm text-slate-400 mb-4">
                  Création d'un tableau de bord PowerBI connecté à un CRM pour
                  suivre le ROI des campagnes en temps réel.
                </p>
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-slate-900 border border-slate-800 transition-all hover:border-indigo-500">
              <div className="h-48 bg-slate-800 relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-indigo-900/50 to-slate-900 flex items-center justify-center">
                  <Smartphone
                    size={48}
                    className="text-indigo-500/50 group-hover:scale-110 transition-transform duration-500"
                  />
                </div>
              </div>
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2 group-hover:text-indigo-400 transition-colors">
                  Site Web Vitrine & SEO
                </h3>
                <p className="text-sm text-slate-400 mb-4">
                  Conception d'un site sur WordPress/React avec stratégie SEO
                  complète pour une PME locale.
                </p>
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-slate-900 border border-slate-800 transition-all hover:border-pink-500">
              <div className="h-48 bg-slate-800 relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-pink-900/50 to-slate-900 flex items-center justify-center">
                  <Mail
                    size={48}
                    className="text-pink-500/50 group-hover:scale-110 transition-transform duration-500"
                  />
                </div>
              </div>
              <div className="p-6">
                ...
                <p className="text-sm text-slate-400 mb-4">
                  Mise en place de scénarios HubSpot pour le lead nurturing et
            ...
            <div className="grid md:grid-cols-2 gap-12 relative z-10">
              <div>
                ...
                <p className="text-slate-400 mb-8">
                  Besoin d'optimiser votre data ou de lancer une nouvelle
                  stratégie digitale ? Je suis disponible pour échanger.
                </p>
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-4 group">
                    ...
                    <div>
                      ...
                      <a
                        href="mailto:juliengarcia9214@gmail.com"
                        className="font-medium hover:text-teal-400"
                      >
                        juliengarcia9214@gmail.com
                      </a>
                    </div>
                  </div>
              ...
              <div className="bg-slate-950/50 p-6 rounded-2xl border border-slate-800">
                ...
                {/* 1. Ajout de action="TON_LIEN_FORMSPREE" */}
                {/* 2. Ajout de method="POST" */}
                {/* 3. Ajout des attributs name="nom", name="email", etc. */}
                <form
                  action="https://formspree.io/f/mvzppnbj"
                  method="POST"
                  className="space-y-4"
                >
                  <div>
      ...
      <footer className="py-8 bg-slate-950 border-t border-slate-900 text-center text-slate-500 text-sm">
        <div className="container mx-auto px-6">
          ...
          <p className="mt-2 text-xs">
            Conçu et développé en React & Tailwind CSS.
          </p>
        </div>
      </footer>
    </div>
